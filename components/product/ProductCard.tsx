    ...
    <>
      <div className="group relative flex flex-col bg-white rounded-xl border border-sandstone-200/90 overflow-hidden shadow-subtle hover:shadow-luxury-hover transition-all duration-300">
        ...
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-sandstone-100">
          <Link href={`/product/${product.slug}`} className="block w-full h-full">
            ...
            <Image
              ...
              fill
              sizes="(max-width: 640px) 50vw, (max-width: 1024px) 33vw, 25vw"
              className="object-cover object-center opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:scale-105"
            />
          </Link>
          ...
          <div className="absolute top-2.5 left-2.5 flex flex-col gap-1 z-10">
            {discountPercent > 0 && (
              <span className="bg-terracotta-600 text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-sm">
                {discountPercent}% OFF
              </span>
            )}
            {product.bestSeller && (
              <span className="bg-warmbrown-900 text-ochre-300 text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded shadow-sm">
                Best Seller
              </span>
            )}
            {product.newArrival && (
              <span className="bg-emerald-700 text-white text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded shadow-sm">
                New
              </span>
            )}
          </div>
          ...
          <button
            ...
            className={`absolute top-2.5 right-2.5 p-2 rounded-full backdrop-blur-md transition-all z-10 ${
              isFavorited
                ? 'bg-jaipur-50 text-jaipur-600 shadow-md scale-110'
                : 'bg-white/80 hover:bg-white text-warmbrown-700 hover:text-jaipur-600 shadow-sm'
            }`}
        ...
        <div className="p-3 sm:p-4 flex flex-col flex-1 justify-between bg-white">
          <div>
            {/* Origin & Material */}
            <div className="flex items-center justify-between text-[10px] sm:text-[11px] font-medium text-sandstone-600 uppercase tracking-wider mb-1">
            ...
            {/* Product Title */}
            <h3 className="font-serif font-bold text-sm sm:text-base text-warmbrown-900 group-hover:text-terracotta-700 transition-colors line-clamp-2 leading-snug">
            ...
            <div className="flex items-center space-x-1.5 mt-1.5">
              ...
              <span className="text-[11px] font-semibold text-warmbrown-800">
                {product.rating}
              </span>
              <span className="text-[10px] text-sandstone-500">
                ({product.reviewCount})
              </span>
            </div>
          </div>
          ...
          <div className="mt-3 pt-2.5 border-t border-sandstone-100 flex items-center justify-between">
            <div>
              <div className="flex items-baseline space-x-1.5">
                <span className="text-sm sm:text-base font-bold text-warmbrown-900">
            ...
            <button
              ...
              className="p-2 sm:px-3 sm:py-1.5 bg-terracotta-50 hover:bg-terracotta-600 text-terracotta-700 hover:text-white rounded-lg text-xs font-semibold flex items-center space-x-1 border border-terracotta-200 hover:border-terracotta-600 transition-all shadow-subtle"
