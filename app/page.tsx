...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24">
      ...
      {/* 1. HERO SECTION                                                          */}
      {/* ========================================================================= */}
      <section className="relative min-h-[70vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden bg-sandstone-900">
        ...
        {/* Hero Content */}
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 text-center text-cream-50 space-y-4 sm:space-y-6 animate-fade-in">
          {/* Heritage Badge */}
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-cream-100/10 backdrop-blur-md border border-cream-100/20 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-ochre-300 max-w-full truncate">
            <Sparkles className="w-3.5 h-3.5 text-ochre-400 shrink-0" />
            <span className="truncate">Master Pit-Loom Weavers • Rajasthan, India</span>
          </div>

          {/* Headline */}
          <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-cream-50 leading-[1.12] max-w-4xl mx-auto">
            Handcrafted Rugs from Jaipur
          </h1>

          {/* Subheading */}
          <p className="text-xs sm:text-lg font-light text-sandstone-200 max-w-2xl mx-auto leading-relaxed px-2">
          ...
          {/* CTAs */}
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-md sm:max-w-none mx-auto">
            <Link
              href="/shop"
              className="w-full sm:w-auto bg-terracotta-600 hover:bg-terracotta-500 text-white px-8 py-3.5 sm:py-4 rounded-xl font-bold text-xs sm:text-sm uppercase tracking-widest transition-all shadow-xl hover:shadow-terracotta-600/30 flex items-center justify-center space-x-2 touch-target"
            >
            ...
            <Link
              href="/custom-rugs"
              className="w-full sm:w-auto bg-cream-50/10 hover:bg-cream-50/20 backdrop-blur-md text-cream-50 border border-cream-100/30 px-8 py-3.5 sm:py-4 rounded-xl font-semibold text-xs sm:text-sm uppercase tracking-widest transition-all flex items-center justify-center space-x-2 touch-target"
            >
          ...
          {/* Value Chips */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-[10px] sm:text-xs font-medium tracking-wider text-sandstone-300 uppercase">
            <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-ochre-400 mr-1.5" /> Handwoven in Jaipur</span>
            <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-ochre-400 mr-1.5" /> 100% Organic Fibers</span>
            <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-ochre-400 mr-1.5" /> Worldwide Express</span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
          ...
          <h2 className="font-serif text-2xl sm:text-4xl font-bold text-warmbrown-900 mt-1">
            Shop by Category
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-6">
          {CATEGORIES.map((category) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4 text-cream-50 flex flex-col justify-end">
                <span className="text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-ochre-300">
                  {category.itemCount} Designs
                </span>
                <h3 className="font-serif font-bold text-sm sm:text-lg group-hover:text-ochre-300 transition-colors leading-snug truncate">
                  {category.name}
                </h3>
                <span className="inline-flex items-center text-[10px] sm:text-[11px] text-sandstone-300 font-medium mt-0.5 group-hover:translate-x-1 transition-transform">
                  <span>Explore</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden bg-warmbrown-900 text-cream-50 shadow-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            {/* Left: Editorial Copy */}
            <div className="p-6 sm:p-12 lg:p-16 space-y-4 sm:space-y-6 z-10">
              <div className="inline-flex items-center space-x-2 text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-ochre-300">
              ...
              <p className="text-xs sm:text-base font-light text-sandstone-200 leading-relaxed">
              ...
              <div className="pt-2 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <Link
                  ...
                  className="bg-terracotta-600 hover:bg-terracotta-500 text-white px-7 py-3.5 rounded-xl font-bold text-xs uppercase tracking-widest transition-all shadow-md flex items-center justify-center space-x-2 touch-target"
                >
                ...
                <Link
                  ...
                  className="bg-cream-100/10 hover:bg-cream-100/20 text-cream-50 border border-cream-100/30 px-6 py-3.5 rounded-xl font-semibold text-xs uppercase tracking-widest transition-colors flex items-center justify-center touch-target"
                >
            ...
            {/* Right: Rich Image */}
            <div className="relative h-64 sm:h-96 lg:h-full min-h-[280px] sm:min-h-[420px] w-full">
              <Image
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center flex-wrap gap-1.5 sm:gap-2 mb-8 sm:mb-10">
          {[
            ...
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-[11px] sm:text-xs font-semibold uppercase tracking-wider transition-all touch-target ${
        ...
        <div className="text-center mt-8 sm:mt-10">
          <Link
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl border-2 border-sandstone-300 hover:border-terracotta-600 text-warmbrown-900 hover:text-terracotta-700 text-xs font-bold uppercase tracking-wider transition-all touch-target"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-3 sm:gap-6">
          {STYLES.slice(0, 6).map((style) => (
            <Link
              ...
              className="group relative h-40 sm:h-64 rounded-2xl overflow-hidden shadow-subtle border border-sandstone-200"
            >
              <Image
                src={style.image}
                alt={style.name}
              ...
              <div className="absolute inset-x-0 bottom-0 p-3 sm:p-5 text-cream-50">
                <span className="text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-ochre-300">
                  {style.count}+ Items
                </span>
                <h3 className="font-serif font-bold text-sm sm:text-xl group-hover:text-ochre-300 transition-colors truncate">
                  {style.name}
                </h3>
              </div>
            </Link>
