    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-12 sm:space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          {/* Pricing Box */}
          <div className="p-4 rounded-2xl bg-sandstone-50 border border-sandstone-200 space-y-1.5">
            <div className="flex items-baseline space-x-3">
              <span className="font-serif text-3xl sm:text-4xl font-bold text-warmbrown-900">
                {formatPrice(activePrice)}
              </span>
              {activeComparePrice && (
                <span className="text-base text-sandstone-400 line-through">
            ...
            <div className="flex items-center space-x-2 text-xs text-emerald-700 font-semibold pt-1">
              <Truck className="w-4 h-4 text-emerald-600" />
              <span>FREE Worldwide Express Shipping on this order</span>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-xs font-bold uppercase tracking-wider text-warmbrown-900">
                Select Rug Dimension: <span className="text-terracotta-600">{selectedVariant.size}</span>
              </label>
              <button
                onClick={() => setIsSizeGuideOpen(true)}
                className="text-xs text-terracotta-600 hover:underline flex items-center space-x-1 font-semibold"
              >
          ...
          {product.colors.length > 0 && (
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-warmbrown-900 mb-2">
                Artisan Palette: <span className="text-terracotta-600 font-medium">{selectedColor}</span>
              </label>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center border border-sandstone-300 rounded-lg bg-white">
              <button
                ...
                className="px-3.5 py-1.5 text-warmbrown-700 hover:text-terracotta-600 font-bold"
                aria-label="Decrease quantity"
              >
                -
              </button>
              <span className="px-4 text-xs font-bold text-warmbrown-900">{quantity}</span>
              <button
            ...
            <span className="text-xs text-sandstone-500">
              {product.stock > 0 ? `${product.stock} in stock ready to ship` : 'Made to order'}
            </span>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 bg-terracotta-600 hover:bg-terracotta-700 text-white py-3.5 px-6 rounded-xl text-xs sm:text-sm font-bold tracking-wider uppercase flex items-center justify-center space-x-2 shadow-md hover:shadow-lg transition-all"
              >
            ...
            <button
              ...
              className="w-full bg-warmbrown-900 hover:bg-warmbrown-800 text-cream-50 py-3.5 px-6 rounded-xl text-xs sm:text-sm font-bold tracking-wider uppercase transition-colors shadow-sm"
            >
            ...
            <Link
              href="/custom-rugs"
              className="w-full py-2.5 px-4 rounded-xl border border-sandstone-300 hover:bg-sandstone-100 text-warmbrown-800 text-xs font-semibold flex items-center justify-center space-x-2 transition-colors"
            >
          ...
          {/* Trust Value Badges */}
          <div className="pt-4 border-t border-sandstone-200 grid grid-cols-3 gap-2 text-center text-[11px] text-sandstone-700">
